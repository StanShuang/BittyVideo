...
class UgcDetailVideoPlayer : StandardGSYVideoPlayer {
    ...
    override fun updateStartImage() {
        if (mStartButton is ImageView) {
            ...
            when (mCurrentState) {
                CURRENT_STATE_PLAYING -> imageView.setImageResource(R.drawable.ic_pause_white_24dp)
                CURRENT_STATE_ERROR -> imageView.setImageResource(R.drawable.ic_play_white_24dp)
                CURRENT_STATE_AUTO_COMPLETE -> imageView.setImageResource(R.drawable.ic_refresh_white_24dp)
